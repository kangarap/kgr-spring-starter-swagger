package com.kgr.framework.web.core.handler;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.kgr.framework.apilog.core.service.ApiErrorLogFrameworkService;
import com.kgr.framework.apilog.core.service.dto.ApiErrorLogCreateDTO;
import com.kgr.framework.common.exception.ServiceException;
...
import static com.kgr.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> defaultExceptionHandler(HttpServletRequest req, Throwable ex) {
        ...
        if(ex.getMessage().contains("重新登录"))
        {
            return CommonResult.error(SSO_EXPIRED.getCode(), SSO_EXPIRED.getMsg());
        }
