...
public class KgrWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                // 设置每个请求的权限
                .authorizeRequests()
                    .antMatchers(api("/api/**")).anonymous()
                    .antMatchers(("/ws/chat")).anonymous()
                    .antMatchers(("/chat")).anonymous()
                    // 登陆的接口，可匿名访问
                    .antMatchers(api("/login")).anonymous()
                    .antMatchers(api("/checkUserToken")).anonymous()
