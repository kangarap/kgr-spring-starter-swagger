package com.kgr.framework.operatelog.core.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @ApiModelProperty(value = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女。")
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "com.kgr.UserController.save(...)")
